...
export default function UsersTab() {
  ...
  return (
    <div className="space-y-6">
      ...
      {roleUpdateMsg && (
        <div className="p-4 rounded-xl bg-indigo-950/80 border border-indigo-800 text-indigo-200 text-xs font-semibold flex items-center gap-2 animate-in fade-in">
