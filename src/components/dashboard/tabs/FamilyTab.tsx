...
export default function FamilyTab() {
  ...
  return (
    <div className="space-y-8 pb-12">
      ...
      {/* 5. Family Members Directory Preview Section */}
            ...
            {filteredMembers.map((m, idx) => (
              ...
              >
                ...
                <div className="pt-2 border-t border-slate-800 flex items-center justify-between text-[11px] font-bold text-purple-400">
                  <Link href="/owner-dashboard?tab=tree" className="hover:underline">
                    View Node ➔
                  </Link>
                  <Link href="/owner-dashboard?tab=members" className="hover:underline text-slate-400">
                    Details
                  </Link>
                </div>
              </div>
