...
function SidebarNavLinks({ isOwnerOrAdmin, pathname, onNavigate }: SidebarNavLinksProps) {
...
export default function SanctuaryDashboardWrapper({
  ...
  return (
    <div className="h-screen overflow-hidden flex bg-slate-950 font-sans text-slate-100 antialiased transition-colors duration-200">
      ...
      >
        <div className="space-y-6 overflow-y-auto">
          ...
          <div className="flex items-center justify-between">
            ...
            >
              <div className="h-9 w-9 rounded-xl bg-purple-600 flex items-center justify-center text-white shadow-md shadow-purple-600/30">
      ...
      <aside className="w-64 bg-slate-900 border-r border-slate-800 hidden lg:flex flex-col justify-between p-6 shrink-0 h-screen transition-colors duration-200 relative z-40">
      ...
      <div className="flex-1 flex flex-col h-screen min-w-0 overflow-hidden">
        ...
        <header className="h-16 shrink-0 bg-slate-900/90 backdrop-blur-md border-b border-slate-800 px-3 sm:px-6 lg:px-8 flex items-center justify-between sticky top-0 z-40 transition-colors duration-200 gap-3">
          <div className="flex items-center gap-2.5 sm:gap-4 flex-1 min-w-0">
            ...
            <div className="relative flex-1 max-w-[140px] min-[420px]:max-w-[190px] sm:max-w-xs md:max-w-sm lg:w-80">
              ...
              <input
                ...
                className="w-full pl-8 sm:pl-9 pr-3 sm:pr-4 py-2 bg-slate-950 border border-slate-800 rounded-full text-xs text-white focus:outline-none focus:ring-2 focus:ring-purple-500 placeholder:text-slate-500 transition-all font-medium"
              />
            </div>
          </div>
          ...
          <div className="flex items-center gap-1.5 sm:gap-3 shrink-0">
            ...
            <div className="pl-1.5 sm:pl-2 border-l border-slate-800">
        ...
        {/* Content Container */}
        <main className="flex-1 overflow-y-auto p-4 sm:p-6 lg:p-8 space-y-6 w-full max-w-full">
          {title && (
