...
export default function DashboardPage() {
  ...
  return (
    <div className="min-h-screen flex bg-slate-950 font-sans text-slate-100 antialiased selection:bg-purple-500 selection:text-white transition-colors duration-200">
      {/* Left Sidebar Navigation */}
      <aside className="w-64 bg-slate-900 border-r border-slate-800 flex flex-col justify-between p-6 shrink-0 sticky top-0 h-screen transition-colors duration-200">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        {/* Top Bar */}
        <header className="h-16 bg-slate-900/90 backdrop-blur-md border-b border-slate-800 px-8 flex items-center justify-end sticky top-0 z-40 gap-3 transition-colors duration-200">
          <ThemeToggle />
