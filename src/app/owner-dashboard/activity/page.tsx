      ...
      <div className="space-y-6 pb-12">
        ...
        <div className="flex flex-wrap items-center justify-between gap-4 p-5 rounded-2xl bg-slate-900 border border-slate-800 shadow-sm">
          <div className="flex items-center gap-3">
            <div className="h-10 w-10 rounded-xl bg-indigo-950/80 text-indigo-400 border border-indigo-800/60 flex items-center justify-center">
              <Clock className="h-5 w-5" />
            </div>
            <div>
              <h3 className="font-extrabold text-white text-sm">Real-Time Event Stream</h3>
          ...
          <div className="flex items-center gap-2">
            <span className="px-3 py-1.5 rounded-xl bg-indigo-950/80 border border-indigo-800/60 text-indigo-300 font-bold text-xs flex items-center gap-1.5">
        ...
        <div className="p-6 rounded-2xl bg-slate-900 border border-slate-800 shadow-sm space-y-4">
          <div className="flex items-center justify-between pb-3 border-b border-slate-800">
            <h4 className="font-extrabold text-sm text-white">Historical Activity Timeline</h4>
          ...
          {isLoading ? (
            ...
            <div className="py-12 flex flex-col items-center justify-center text-center space-y-2">
              ...
              <h5 className="font-bold text-white text-sm">No activity recorded yet</h5>
            ...
            <div className="space-y-4">
              {activityLogs.map((log, idx) => (
                <div
                  key={log.id || idx}
                  className="p-4 rounded-xl bg-slate-950 border border-slate-800 hover:bg-slate-800/60 transition-colors flex items-start gap-4"
                >
                  <div className="h-10 w-10 rounded-xl bg-indigo-950/80 text-indigo-400 border border-indigo-800/60 flex items-center justify-center shrink-0 mt-0.5 shadow-sm">
                  ...
                  <div className="flex-1 space-y-1">
                    ...
                    {log.user && (
                      <div className="pt-1 flex items-center gap-1.5 text-[10px] font-bold text-indigo-400">
